...
namespace MultiWindowApp
{
    public partial class Bio : Form
    {
        ...
        private void BtnPerc_Click(object sender, EventArgs e)
        {
            ...
            int Biology = Convert.ToInt32(TbBio.Text);
            ...
            double obtPerc = ((English + Urdu + Mathematics + PakStudies + Islamiat + Biology + Physics + Chemistry) * 100) / (subjectTotal * subjectNo);
